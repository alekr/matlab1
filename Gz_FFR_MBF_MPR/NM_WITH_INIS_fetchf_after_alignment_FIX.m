function [F, p, error, exitflag]=NM_WITH_INIS_fetchf_after_alignment_FIX(fit_time, fit_aif, fit_myo, inis)
% evals = 60000;
% iters = 10000;
...
options = optimset('OutputFcn',outputFcn,'TolX',1e-12, 'MaxFunEvals', evals, 'MaxIter', iters);%changed from 0.1
